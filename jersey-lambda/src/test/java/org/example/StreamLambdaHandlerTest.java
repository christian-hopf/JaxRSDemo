...
//    @Test
//    public void messages_streamRequest_respondsWithMessages() {
//        InputStream requestStream = new AwsProxyRequestBuilder("/messages", HttpMethod.GET)
//                .header(HttpHeaders.ACCEPT, MediaType.APPLICATION_JSON)
//                .buildStream();
//        ByteArrayOutputStream responseStream = new ByteArrayOutputStream();
//
...
//        assertFalse(response.isBase64Encoded());
//
//        assertTrue(response.getBody().contains("Good morning"));
//        assertTrue(response.getBody().contains("Good night"));
//
//        assertTrue(response.getHeaders().containsKey(HttpHeaders.CONTENT_TYPE));
//        assertTrue(response.getHeaders().get(HttpHeaders.CONTENT_TYPE).startsWith(MediaType.APPLICATION_JSON));
//    }
